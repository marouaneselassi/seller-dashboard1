...
const AsideDefault: FC = () => {
  ...
  return (
    ...
    >
        ...
        {aside.theme === 'dark' && (
          <Link to='/dashboard'>
            <img
              ...
              src="https://lna-cdn.s3-ap-southeast-1.amazonaws.com/uploads/all/dv6PFdGhpYD13DXSA7gEQZnD1doG4z9Zf8AYjVg2.png"
            />
          </Link>
        )}
        {aside.theme === 'light' && (
      ...
      {/* begin::Footer */}
      <div className='aside-footer flex-column-auto pt-5 pb-7 px-5 d-none' id='kt_aside_footer'>
        <a
          target='_blank'
